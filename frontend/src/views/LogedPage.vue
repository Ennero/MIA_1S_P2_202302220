            ...
            <div class="col-md-10">
                ...
                <div class="card border-0 shadow-lg mb-4 bg-white rounded">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-2">
                                <button class="btn btn-warning w-100 d-flex justify-content-center align-items-center"
                                    @click="cerrarSesion">
                ...
                <div class="card border-0 shadow-lg bg-white rounded">
                    ...
                    <div class="card-footer bg-light p-3 d-flex justify-content-between align-items-center">
                        <button class="btn btn-info d-flex justify-content-center align-items-center" @click="Disks">
                            <i class="bi bi-box-arrow-in-right me-1"></i>Ir a discos
                        </button>
    ...
    methods: {
        ...
        async cerrarSesion() {
            ...
            try {
                ...
                else { console.log("Logout backend:", data.output || "(OK)"); this.$router.push('/'); // Ir a la página de inicio (no logueado)
            }
            } catch (error) {
                // Error de red, pero continuamos con el logout del frontend
                console.error("Error fetch en logout:", error);
                this.salida += "\nError de conexión al cerrar sesión en backend, cerrando localmente.";
            }
        },
        async Disks() {
